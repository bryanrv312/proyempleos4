...
public class DatabaseWebSecurity /*extends WebSecurityConfigurerAdapter*/{
	...
	protected SecurityFilterChain filterchain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests()
			...
			.requestMatchers("/usuarios/editarUsuario").hasAnyAuthority("USUARIO", "SUPERVISOR","ADMINISTRADOR")
			.requestMatchers("/usuarios/editarCorreo").hasAnyAuthority("USUARIO", "SUPERVISOR","ADMINISTRADOR")
			.requestMatchers("/usuarios/editarPassword").hasAnyAuthority("USUARIO", "SUPERVISOR","ADMINISTRADOR")
			.requestMatchers("/usuarios/formSetting").hasAnyAuthority("USUARIO", "SUPERVISOR","ADMINISTRADOR")
